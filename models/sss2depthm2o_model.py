...
class Sss2DepthM2OModel(BaseModel):
    """ This class implements the sss2depthm2o model, for learning a mapping from input images to output images given paired data.
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='instance', netG='resnet_7blocks', dataset_mode='alignedm2o')
        if is_train:
...
#         print("self.fake_B shape: ", self.fake_B.size())
